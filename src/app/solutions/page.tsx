  ...
  const coreFeatures = [
    {
      ...
      details: 'Web forms, email forwarding, chat widgets, API integrations, and mobile submissions all flow into a single ticket queue.',
    ...
    },
    {
      ...
      details: 'Route by department, priority level, client type, or custom rules. Load balancing ensures even distribution of work.',
      benefits: ['Faster response times', 'Balanced workloads', 'Expertise matching'],
      color: 'bg-yellow-500'
    },
    {
      icon: CogIcon,
      ...
      details: 'Set up triggers for deadlines, escalations, notifications, and status updates. Create custom workflows for any process.',
    ...
    },
    {
      ...
      details: 'Clients can submit requests, track progress, approve work, and access resources through a fully branded portal.',
      benefits: ['Reduced support load', 'Client satisfaction', 'Professional image'],
      color: 'bg-yellow-500'
    },
    {
      icon: LinkIcon,
      ...
      details: 'Native integrations with email, calendar, storage, CRM, and productivity tools. Plus webhooks and API access.',
    ...
    },
    {
      ...
      details: 'Role-based permissions, audit trails, SSO support, and compliance with SOC 2, GDPR, and industry standards.',
  ...
  const faqs = [
    {
      ...
      answer: 'Most teams are up and running within 3-5 business days. Our setup includes data migration assistance, team training, and custom configuration to match your workflow. Enterprise clients with complex requirements may take 1-2 weeks for full deployment.',
      category: 'Getting Started'
    },
    {
      question: 'Can you migrate our existing support data?',
      answer: 'Yes, we provide comprehensive data migration services. We can import your tickets, customer data, and conversation history from most popular platforms including Zendesk, Freshdesk, Intercom, and custom systems. Our team handles the technical details to ensure a smooth transition.',
      category: 'Migration'
    },
    {
      question: 'Is the client portal mandatory for all customers?',
      answer: 'No, the client portal is completely optional. You can enable it for some clients and not others, or add it later as your needs evolve. Many businesses start with email-based support and gradually introduce the portal as they scale.',
      category: 'Features'
    },
    {
      question: 'What integrations are available?',
      answer: 'ReplySystem integrates with popular tools including Slack, Microsoft Teams, Zapier, Google Workspace, Microsoft 365, and major CRM platforms. We also offer webhooks and a REST API for custom integrations. New integrations are added regularly based on customer requests.',
      category: 'Integrations'
    },
    {
      question: 'How does pricing work for multiple team members?',
      answer: 'Our pricing is per active agent, not per total user. You can have unlimited read-only users (like managers or executives) at no extra cost. We offer volume discounts for teams of 10+ agents and custom enterprise pricing for larger organizations.',
      category: 'Pricing'
    },
    {
      question: 'What kind of reporting and analytics do you provide?',
      answer: 'Our reporting includes response time metrics, resolution rates, customer satisfaction scores, agent performance, and ticket volume trends. You can create custom dashboards, schedule automated reports, and export data for external analysis. All reports are real-time and fully customizable.',
      category: 'Analytics'
    },
    {
      question: 'Is my data secure and compliant?',
      answer: 'Yes, we maintain SOC 2 Type II compliance, GDPR compliance, and use enterprise-grade security including 256-bit SSL encryption, regular security audits, and data backup redundancy. Your data is hosted in secure, certified data centers with 99.9% uptime guarantee.',
      category: 'Security'
    },
    {
      question: 'Can I customize the look and feel for my clients?',
      answer: 'Absolutely! You can fully brand the client portal with your logo, colors, and custom domain. The interface adapts to your brand guidelines, and you can customize email templates, notification messages, and even add custom fields specific to your business.',
      category: 'Customization'
    },
    {
      question: 'What happens if I need to cancel my subscription?',
      answer: 'You can cancel anytime with 30 days notice. We provide full data export in standard formats (CSV, JSON) so you can migrate to another platform if needed. There are no cancellation fees, and you retain access to your data during the notice period.',
      category: 'Account Management'
    },
    {
      question: 'Do you offer training and onboarding support?',
      answer: 'Yes, all plans include comprehensive onboarding with dedicated setup assistance, team training sessions, and ongoing support. We provide video tutorials, documentation, and live training sessions. Premium and Enterprise plans include dedicated customer success managers.',
      category: 'Support'
    }
  ];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              Each feature is built to scale with your team and adapt to your unique workflow.
            </p>
          </div>
              ...
              {coreFeatures.map((feature) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center">
                    <div className={`flex h-16 w-16 items-center justify-center rounded-2xl ${feature.color} group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600">
              Get answers to common questions about ReplySystem. Can&apos;t find what you&apos;re looking for? Contact our support team.
            </p>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-2xl text-center">
            <div className="rounded-2xl bg-white p-8 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600 mb-6">
                Our support team is here to help you get the most out of ReplySystem.
              </p>
